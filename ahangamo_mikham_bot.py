...
async def send_welcome(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(
        ...
        "با من می‌تونی ویدیوهای یوتیوب رو پیدا کنی و دانلود کنی. برای شروع دکمه 'شروع' رو بزن! 🚀",
...
async def ask_for_speed_check(query):
    ...
    await query.message.reply_text(
        "👨‍💻 آیا می‌خواهید سرعت اینترنت و پینگ خود را مشاهده کنید؟"
         "ممکنه یمقدار طول بکشه یکبار دکمه بله رو بزن و یکم صبور باش ممنونتم\n"
,
        reply_markup=reply_markup
    )
...
async def handle_speed_check_response(update: Update, context: CallbackContext):
    ...
    if query.data == 'yes_speed':
        ...
        speed_message = (
            ...
            f"📶 پینگ: {ping} ms\n\n"
            "🔮شرایط سخت زندگی ما، هم مثل سرعت اینترنت ماست، یه روزی بالا میره داداشم 💫"
        ...
        await query.message.reply_text("🚶‍♂️ بریم دوباره شروع کنیم!")
